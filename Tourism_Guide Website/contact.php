...
<body>
    <div class="full-page">
        <div class="navbar">
            <div>
                <a href='website.html'>Web Techno</a>
            </div>
            <nav>
                <ul id='MenuItems'>
                    <li><a href='#'>Home</a></li>
        ...
        <div id='login-form' class='login-page'>
            <div class="form-box">
                ...
                <form action="insert01.php" method="post" id='login' class='input-group-login'>
                    <input type='text' class='input-field' name="email" placeholder='Email Id' required>
                    <input type='password' class='input-field' name="password" placeholder='Enter Password' required>
                    <input type='checkbox' class='check-box'><span>Remember Password</span>
                    <button type='submit' class='submit-btn'>Log in</button>
                </form>
                <form action="insert02.php" id='register' class='input-group-register'>
